...
// ' Вивести кожну книгу як окремий об'єкт
        ...
        let masive2 = [[{name: "War",
    number_of_pages: 200,
    genre: "detective",
    authorsNew = {name:"Koval Petro", name: "Maksymiv Taras", name: "Melnyk Bogdan"}]+
        [{name: "Lucky",
        number_of_pages: 235,
        genre: "drama",
        authors: {"Voitovuch Andriy", "Polomanuy Ostap",  "Makoveckuy Bogdan"}}];
